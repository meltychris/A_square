...
public class DataBaseTestAdapter3  
{ 
    ...
    public DataBaseTestAdapter3(Context context)  
    { 
        this.mContext = context; 
        mDbHelper = new DataBaseHelper3(mContext); 
    } 
 
    public DataBaseTestAdapter3 createDatabase() throws SQLException  
    { 
        try  
        { 
    ...
    public DataBaseTestAdapter3 open() throws SQLException  
    { 
        try  
        { 
	...
	public boolean SaveInfo(String user, String msg) 
 	{
 		try
 		{
            mDbHelper.openDataBase(); 

	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		buttonGPAadvice1_1.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View v) {
				...
				String str_targetTGA = editTextGPAadvice1_1.getText()
						.toString();

				double targetTGA = Double.parseDouble(str_targetTGA);

				// transfer info to advice2.java
				// The minus 1 operation did in advice2 when calling function to
				// calculate
				...
				// DisplayToast("courseCode = " +
				// MainActivity.student1.courseRecord[0][0][0][0]);
				// DisplayToast("credit = " +
				// MainActivity.student1.courseRecord[0][0][0][1]);
				// DisplayToast("grade = " +
				// MainActivity.student1.courseRecord[0][0][0][2]);

				// DisplayToast("This course record is added!");

				intent.setClass(ustTeamActivity.this, advice2.class);
